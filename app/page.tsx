    ...
    <div className="min-h-screen bg-[#fffffe] dark:bg-[#0e0e0e]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#fffffe]/80 dark:bg-[#0e0e0e]/80 backdrop-blur-md border-b border-black/8 dark:border-white/8">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a
              href="#features"
              className="text-sm font-medium text-[#0e0e0e] dark:text-[#fffffe] hover:text-primary transition-colors"
            >
              Features
            </a>
            <a
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-24 pb-16 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h1
            className="text-6xl md:text-8xl lg:text-[96px] font-bold tracking-[-0.06em] leading-[1.1] text-[#0e0e0e] dark:text-[#fffffe] mb-6 animate-fade-in-up"
          ...
          <p
            className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up"
            style={{ animationDelay: "0.2s" }}
          >
            Let AI agents handle resume screening, shortlisting, and initial
            interviews. Focus on what matters - meeting the best candidates.
          </p>
          ...
          >
            ...
            <button className="relative px-8 py-4 bg-transparent border-2 border-[#0e0e0e] dark:border-[#fffffe] text-[#0e0e0e] dark:text-[#fffffe] rounded-full font-semibold text-base overflow-hidden group flex items-center gap-2">
              ...
              <span className="absolute inset-0 bg-[#0e0e0e] dark:bg-[#fffffe] -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out"></span>
          ...
          <div
            className="grid grid-cols-3 gap-8 max-w-3xl mx-auto mt-20 animate-fade-in-up"
            style={{ animationDelay: "0.4s" }}
          >
            <div className="group cursor-pointer">
              <div className="text-4xl md:text-5xl font-bold text-[#0e0e0e] dark:text-[#fffffe] mb-2 group-hover:text-primary transition-colors">
          ...
          <div className="flex animate-scroll whitespace-nowrap ticker-content">
            {[...Array(2)].map((_, i) => (
              <div key={i} className="flex items-center">
                <span className="mx-8 text-2xl font-bold text-gray-300 dark:text-gray-700 ticker-item transition-colors duration-300">
                  TechCorp
                </span>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Our intelligent agents handle the entire recruitment pipeline,
            ...
            {[
              {
                ...
                description:
                  "AI automatically extracts and analyzes candidate information, skills, and experience from any resume format.",
                delay: "0s",
              },
              {
                icon: Zap,
                ...
                description:
                  "Intelligent matching algorithms rank candidates based on job requirements and company culture fit.",
                delay: "0.1s",
              },
              {
                icon: Calendar,
                ...
                description:
                  "Automatically send interview invitations and manage scheduling without any manual intervention.",
                delay: "0.2s",
              },
              {
                icon: MessageSquare,
                title: "AI Interviews",
                description:
                  "Conversational AI conducts initial interviews, asks relevant questions, and evaluates responses naturally.",
                delay: "0.3s",
              },
              {
                icon: BarChart3,
                ...
                description:
                  "Get comprehensive interview reports with candidate insights, strengths, and recommendations.",
                delay: "0.4s",
              },
              {
                icon: Shield,
                ...
                description:
                  "AI ensures fair evaluation based solely on qualifications, eliminating unconscious bias.",
                delay: "0.5s",
              },
            ].map((feature, index) => (
              <div
      ...
      <section
        id="how-it-works"
        className="py-24 px-6 bg-gray-50 dark:bg-[#1f2124] relative overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="group relative bg-white dark:bg-[#0e0e0e] rounded-3xl p-8 border border-black/8 dark:border-white/8 hover:border-[#ff480e]/50 transition-all hover:shadow-2xl hover:-translate-y-2 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-bold text-[#0e0e0e] dark:text-[#fffffe] mb-4">
                Post Your Job
              </h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                Create comprehensive job listings with AI-powered optimization.
                Our intelligent system helps you attract the right candidates.
              </p>
              <div className="flex flex-wrap gap-2">
                {["Templates", "AI Optimization", "Multi-platform"].map(
                  (tag, i) => (
                    <span
                      key={i}
          ...
          <div className="group relative bg-white dark:bg-[#0e0e0e] rounded-3xl p-8 border border-black/8 dark:border-white/8 hover:border-[#ff480e]/50 transition-all hover:shadow-2xl hover:-translate-y-2 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                Advanced AI analyzes applications instantly, extracting key
                information and ranking candidates by fit. Never miss qualified
                talent.
              </p>
              <div className="flex flex-wrap gap-2">
                {["Smart Parsing", "Skills Match", "Culture Fit"].map(
                  (tag, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 bg-[#ff480e]/10 text-primary text-sm rounded-full"
          ...
          <div className="group relative bg-white dark:bg-[#0e0e0e] rounded-3xl p-8 border border-black/8 dark:border-white/8 hover:border-[#ff480e]/50 transition-all hover:shadow-2xl hover:-translate-y-2 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                AI agents conduct natural, conversational interviews 24/7.
                Candidates complete interviews at their convenience with
          ...
          <div className="group relative bg-white dark:bg-[#0e0e0e] rounded-3xl p-8 border border-black/8 dark:border-white/8 hover:border-[#ff480e]/50 transition-all hover:shadow-2xl hover:-translate-y-2 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                Get detailed reports with insights, strengths, and AI
                recommendations. Make confident, data-driven hiring decisions
                quickly.
              </p>
              <div className="flex flex-wrap gap-2">
            ...
            {[
              {
                ...
                content:
                  "AIVOX reduced our time-to-hire by 70%. The AI interviews are incredibly natural and candidates love the flexibility.",
                rating: 5,
              },
              {
                name: "Michael Chen",
                ...
                content:
                  "We've screened over 5,000 candidates with AIVOX. The accuracy is impressive and we've made significantly better hires.",
                rating: 5,
              },
              {
                ...
                content:
                  "Game changer! The detailed reports save us hours of work and the bias-free screening ensures we see all qualified candidates.",
                rating: 5,
              },
              ...
              >
                ...
                <div>
                  <div className="font-semibold text-[#0e0e0e] dark:text-[#fffffe]">
                    {testimonial.name}
                  </div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                    {testimonial.role}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white dark:bg-[#0e0e0e] rounded-3xl p-8 border border-black/8 dark:border-white/8 hover:border-[#ff480e]/50 transition-all hover:scale-105">
              ...
              <div className="mb-6">
                <span className="text-5xl font-bold text-[#0e0e0e] dark:text-[#fffffe]">
                  $99
                </span>
              ...
              <button className="relative w-full px-6 py-3 bg-transparent border-2 border-[#0e0e0e] dark:border-[#fffffe] text-[#0e0e0e] dark:text-[#fffffe] rounded-full font-semibold overflow-hidden group">
                <span className="relative z-10">Get Started</span>
                <span className="absolute inset-0 bg-[#0e0e0e] dark:bg-[#fffffe] -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out"></span>
                <span className="absolute inset-0 flex items-center justify-center text-[#fffffe] dark:text-[#0e0e0e] opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20">
                  Get Started
                </span>
              </button>
            </div>
            ...
            <div className="bg-[#ff480e] rounded-3xl p-8 relative transform md:scale-105 shadow-2xl">
              ...
              <button className="relative w-full px-6 py-3 bg-white text-primary rounded-full font-semibold overflow-hidden group">
                <span className="relative z-10">Get Started</span>
                <span className="absolute inset-0 bg-linear-to-r from-white via-gray-100 to-white -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-in-out"></span>
              </button>
            </div>
            ...
            {[
              {
                ...
                answer:
                  "Our AI screening achieves 95%+ accuracy by analyzing resumes against job requirements, skills matching, and cultural fit indicators. The system continuously learns from feedback to improve its accuracy over time.",
              },
              {
                question: "Can I customize the interview questions?",
                answer:
                  "Absolutely! You have full control over interview questions. Create custom question sets tailored to specific roles, or use our AI-suggested questions based on the job description and industry best practices.",
              },
              {
                question: "How long does the AI interview process take?",
                answer:
                  "AI interviews typically take 15-30 minutes depending on the role complexity. Candidates can complete interviews at their convenience 24/7, and you'll receive detailed reports within minutes of completion.",
              },
              {
                question: "Is my candidate data secure?",
                answer:
                  "Yes, security is our top priority. We use enterprise-grade encryption, comply with GDPR and SOC 2 standards, and never share candidate data with third parties. All data is stored securely and can be deleted upon request.",
              },
              {
                question: "Can I integrate AIVOX with my existing ATS?",
                answer:
                  "Yes, AIVOX integrates seamlessly with popular ATS platforms including Greenhouse, Lever, Workday, and more. Our API also allows for custom integrations with your existing HR tools.",
              },
              {
                question:
                  "What happens if a candidate needs special accommodations?",
                answer:
                  "We're committed to accessibility. Candidates can request accommodations, and our platform supports various accessibility features including extended time, screen readers, and alternative interview formats.",
              },
            ].map((faq, index) => (
              <div
                key={index}
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button className="relative px-8 py-4 bg-transparent border-2 border-[#fffffe] text-[#fffffe] rounded-full font-semibold text-base overflow-hidden group">
              ...
              <span className="absolute inset-0 bg-[#fffffe] -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out"></span>
              <span className="absolute inset-0 flex items-center justify-center text-[#0e0e0e] opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20">
                Schedule Demo
              </span>
            </button>
          </div>
      ...
      <footer className="py-12 px-6 border-t border-black/8 dark:border-white/8 bg-white dark:bg-[#0e0e0e]">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h4 className="font-semibold text-[#0e0e0e] dark:text-[#fffffe] mb-4">
                Product
              </h4>
